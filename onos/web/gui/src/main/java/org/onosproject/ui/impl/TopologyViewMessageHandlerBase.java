...
public abstract class TopologyViewMessageHandlerBase extends UiMessageHandler {
    ...
    protected PropertyPanel deviceDetails(DeviceId deviceId) {
        ...
        //my new show importance
        addImportanceProps(pp, annot,lion);
    ...
    // easy test for addImportance
    private void addImportanceProps(PropertyPanel pp, Annotations annot,
                                  LionBundle lion) {
        String importance = annot.value("importance");
        if(importance == null || "".equals(importance)){
            importance = "default-1";
        }
        pp.addProp("importance", "Importance", importance)
                .addSeparator();
    }
